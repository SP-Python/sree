...
<head>
    ...
    <title>incremental_helper_functions_automation.py (editing)</title>
...
<body class="edit_app " 
data-base-url="/"
data-file-path="Dom/Incremental%20Checking/incremental_helper_functions_automation.py"
